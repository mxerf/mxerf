      ...
      <div className=''>
        <div className='mb-8'>
          <div className='mb-4 space-y-2'>
            <h3 className='milestone-title'>Major Accomplishments and Project Expansions</h3>
            <p className='milestone-description'>
              Successfully delivered several substantial projects, each designed to enhance
              efficiency and engagement in different domains. These include the development of an{" "}
              <span className='text-lime-600 dark:text-lime-400'>
                intelligent testing platform (ISTOK)
              </span>
              , enabling comprehensive evaluation of linguistic competencies using artificial
              intelligence models; as well as a{" "}
              <span className='text-blue-400'>multi-functional personal account system</span>{" "}
              tailored for students, parents, and staff of an educational institution.
            </p>
          </div>
          <div className='experience-card-gradient-box mb-4'>
            <GradientCard
              ...
              className='h-max'>
              <p className='experience-card-gradient-text from-[#BDED4D] from-35% to-[#2D4298]'>
                istok test.
              </p>
              <Image
                src={istokImage}
            ...
            <GradientCard
              ...
              className='h-max'>
              <p className='experience-card-gradient-text from-[#FAFAFC] to-75% to-[#3C51A2]'>
                lk jftl.
              </p>
              <Image
                src={jftlImage}
        ...
        <div className='mb-8'>
          <div className='my-4 space-y-2'>
            <h3 className='milestone-title'>Side Projects and Independent Development</h3>
            <p className='milestone-description'>
              In addition to the aforementioned projects, and several custom solutions have been
              successfully implemented. These include the development of a{" "}
              <span className='text-[#9A5501]'>designer&apos;s portfolio</span>, a{" "}
              <span className='text-[#E4C167]'>custom CRM</span> for a carwash and a{" "}
              <span className='text-chart-3'>voting platform</span> for corporate competitions
              within <span className='text-chart-3'>Russian Railways (RZD)</span>, ensuring
              transparency and accessibility in decision-making processes.
            </p>
          </div>
      ...
      <div>
        <div className='mb-4 space-y-2'>
          ...
          <p className='milestone-description'>
            ...
            <br />
            <span className='text-chart-1'> e-commerce platform</span> and a cutting-edge
            <span className='text-chart-3'> Progressive Web Application (PWA)</span> for a beauty
            service provider.
          </p>
          <p className='milestone-description'>
            Secured an official position as a{" "}
            <span className='text-chart-2'>Frontend Developer at MIPT</span>, contributing to
            large-scale educational initiatives. Additionally, took the lead in the development and
            enhancement of the <span className='text-chart-2'>chatsky-ui</span> project (formerly
            known as{" "}
            <span className='text-emerald-600 dark:text-emerald-300'>dialog-flow-designer</span>)
            from scratch, focusing on improving UI/UX solutions for adaptive dialogue assistant
            development tools.
          </p>
        </div>
        <div className='experience-card-gradient-box'>
          <GradientCard
            ...
            <p className='experience-card-gradient-text from-[#FFAD0D] from-25% to-[#01A2FF]'>
              chatsky-ui.
            </p>
            <Image
              src={chatskyUiImage}
          ...
          <GradientCard
            ...
            <p className='experience-card-gradient-text from-[#01A2FF] to-65% to-[#FFAD0D]'>
              chatsky docs.
            </p>
            <Image
    ...
    content: (
      <div>
        <div className='space-y-2 mb-4'>
          ...
          <p className='milestone-description'>
            Initiated my path in software development by mastering the fundamental principles of
            <span className='bg-orange-600 text-white px-1 inline-block rounded'> HTML</span>{" "}
            <span className='bg-purple-600/80 text-white px-1 inline-block rounded'> CSS</span> and{" "}
            <span className='bg-yellow-400 text-black px-1 inline-block rounded'> JavaScript</span>{" "}
            .
          </p>
          <p className='milestone-description'>
            Additionally, I embarked on the study of{" "}
            <span className='text-cyan-500 bg-black/5 dark:bg-white/20 px-1 inline-block rounded'>
              React
            </span>{" "}
            and <span className='bg-blue-600 text-white px-1 inline-block rounded'>TypeScript</span>
        ...
        <div className='experience-card-gradient-box'>
          <GradientCard
            ...
            <p className='experience-card-gradient-text to-[#3D4CD9] via-[#3D4CD9] from-[#FFC700] from-35%'>
              avtomix.
            </p>
            <Image
              src={avtomixImage}
